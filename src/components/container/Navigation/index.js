...
const NavigtionBar = () => {
  return (
    <section className="navigation d-flex border navigation-bar">
      <div className="navigation__hn-logo mx-1 d-flex align-self-center cursor">
      ...
      <div className="navigation__tabs d-flex">
        <p className="mb-0 mx-1 cursor">new |</p>
        <p className="mb-0 mx-1 cursor">comments |</p>
        <p className="mb-0 mx-1 cursor">show |</p>
        <p className="mb-0 mx-1 cursor">ask |</p>
        <p className="mb-0 mx-1 cursor">jobs</p>
      </div>
    </section>
  );
};
